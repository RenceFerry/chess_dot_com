...
import ProfileDetails from '@/_components/[user]/sections/home/profileDetails';
...
const Home = () => {
  return (
    <div className='w-full h-full min-h-0 flex flex-col justify-start p-5 items-center'>
      ...
      {/** game history */}
      <h1 className='self-start font-semibold mt-3 text-brown1 md:text-xl'>Game History</h1>
